#Program For Naive Bayes Classifier using R
#@author: Sourav Nandi  ;   Project Work in ISI Kolkata
#DataSets: From R package "datasets"
...
t1<- table(predict(nbc1, iris.test[, -5]), iris.test[, 5])
View(t1)
# ==========================================================
...
t2 <- table(predict(nbc2, vote.train[, -1]), vote.train[, 1])
View(t2)
...
# Clear plots
# dev.off()  # Link: http://j.mp/1RgKR8i
