# -*- coding: utf-8 -*-
#Sourav Nandi; Project Work in ISI Kolkata in Dec 2017
import csv
...
Executing: iris dataset
Split 50 rows into train=101 and test=50 rows
Identified 3 different target classes: ['Iris-virginica', 'Iris-setosa', 'Iris-versicolor']
Accuracy: .900, 0.800, 0.840, 0.790

 ************ 

Executing: redwine dataset
Split 528 rows into train=1071 and test=528 rows
Identified 6 different target classes: [3.0, 4.0, 5.0, 6.0, 7.0, 8.0]
Accuracy: 0.670, 0.745, 0.640, 0.637

 ************ 

Executing: adult dataset
Split 3300 rows into train=6700 and test=3300 rows
Identified 2 different target classes: ['male', 'female']
Accuracy: 0.522, 0.455, 0.632, 0.722

 ************ 

Executing: diabetes dataset
Split 254 rows into train=514 and test=254 rows
Identified 2 different target classes: [0.0, 1.0]
Accuracy: 0.799, 0.783, 0.693, 0.671
"""